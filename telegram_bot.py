...
async def contact_us(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    await query.edit_message_text("يمكنك التواصل معنا عبر الرسائل المباشرة على تليجرام\\: \\@Mashro3yPlusBot \\(هذا مجرد مثال، يرجى استبداله بمعرف تواصل حقيقي أو رابط\\)", parse_mode="MarkdownV2")
